...
--
-- Table structure for table `phast`
--

DROP TABLE IF EXISTS `phast`;
...
--
-- Dumping data for table `phast`
--

LOCK TABLES `phast` WRITE;
/*!40000 ALTER TABLE `phast` DISABLE KEYS */;
INSERT INTO `phast` VALUES (51,1);
/*!40000 ALTER TABLE `phast` ENABLE KEYS */;
UNLOCK TABLES;
