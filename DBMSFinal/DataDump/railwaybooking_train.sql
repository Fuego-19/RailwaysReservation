...
INSERT INTO `train` VALUES (1,'Duronto'),(2,'Shatabdi'),(3,'Rajdhani'),(4,'Express'),(5,'Gatimaan'),(6,'Superfast');
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `train_BEFORE_INSERT` BEFORE INSERT ON `train` FOR EACH ROW BEGIN
	...
	IF NEW.train_name in (select train_name from train )
    THEN SET msg = "Train already exists";
    END IF;
